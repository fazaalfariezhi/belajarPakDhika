...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2"><a href="/dashboard/posts/{{ $post->slug }}"><img src="{{ asset('img/arrow-left-circle.svg') }}" alt="arrowBack" style="margin-bottom: 1px"></a> Edit Post</h1>
</div>
<div class="col-lg-8">
    <form action="/dashboard/posts/{{ $post->slug }}" method="POST" class="mb-5" enctype="multipart/form-data">
      ...
      @csrf
        ...
        <div class="mb-3">
          ...
          @if ($post->image)
            <img src="{{ asset('storage/' . $post->image) }}" class="img-preview img-fluid mb-3 img-thumbnail col-sm-5 d-block" style="max-height: 400px;">
          @else
