    ...
    <div class="row justify-content-center">
        <div class="col-md-5">
            <main class="form-registration">
                <h1 class="h3 mb-4 fw-normal text-center"><b>Buat Akun</b></h1>              
                ...
                <small class="d-block text-center mt-2"> Sudah punya akun? <a href="/login" class="text-decoration-none">Login!</a></small>
              </main>
        </div>
    </div>
</div>
